...
<head>
    ...
    <title>Send money | Your Bank</title>
</head>
...
<body style="padding-top:8%;">
    ...
    <nav class="navbar navbar-expand-lg bg-light fixed fixed-top"
    ...
    <center>
        ...
        <div class="container" style="margin-top:2%;">
            <div
                style="width:80%; padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px gray;">
                <h1 style=" color:#fff;">Transfer Money</h1>
            </div>
            <br><br>
            <div class="" style=" backdrop-filter: blur(5px);  border-radius:5px;  ">
                <form action="send_money.php" method="post">
                    ...
                    <br><input class="btn mybtn btn-primary" type="submit" value="Transfer"><br><br>
                    <p style="color:#222;">Want to check your balance? check <a href="check_blc.php">here</a></p>
                </form>
            </div>
        </div>
